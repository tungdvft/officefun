      ...
      <transition name="fade-slide">
        ...
        <div v-else-if="error" class="text-center py-12 bg-red-50 rounded-lg">
          ...
          <p class="text-gray-600 mt-1">
            Vui lòng nhập đầy đủ họ tên và ngày sinh hợp lệ (DD/MM/YYYY) để xem chỉ số năng lực tiếp cận
          </p>
        </div>
...
const showResult = computed(() => {
  return capacityData.value !== null && capacityNumber.value !== null && !error.value;
});
