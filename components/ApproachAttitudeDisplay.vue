        ...
        <div v-else-if="showResult" class="space-y-6">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-100 shadow-sm text-center">
            <div class="flex flex-col items-center">
              ...
              <h3 class="text-2xl font-bold text-teal-800 mt-6">Chỉ Số Thái Độ Tiếp Cận {{ attitudeNumber }}</h3>
...
const showResult = computed(() => {
  return attitudeData.value && attitudeNumber.value !== null;
});
...
const loadAttitudeData = async () => {
  ...
  try {
    ...
    attitudeNumber.value = calculateApproachAttitudeNumber(props.fullName, props.birthDate);
    ...
    attitudeData.value = {
      description: `Tạm thời chưa có dữ liệu chi tiết cho Chỉ số Thái Độ Tiếp Cận ${attitudeNumber.value || 'không xác định'}`,
