        ...
        <div v-else-if="showResult" class="space-y-6">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-100 shadow-sm text-center">
            <div class="flex flex-col items-center">
              ...
              <h3 class="text-2xl font-bold text-teal-800 mt-6">Chỉ Số Vượt Khó {{ challengeNumber }}</h3>
...
const loadChallengeData = async () => {
  ...
  try {
    ...
    challengeData.value = {
      description: `Tạm thời chưa có dữ liệu chi tiết cho Chỉ số Vượt Khó ${challengeNumber.value || 'không xác định'}`,
