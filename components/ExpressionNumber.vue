  ...
  <div class="container mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
    <div class="p-6 space-y-8">
      ...
      <transition name="fade-slide">
        <!-- Main content -->
        <div v-if="expressionData" class="space-y-8">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-100 shadow-sm text-center">
            <div class="flex flex-col items-center">
              ...
              <p class="text-gray-600 mt-2 max-w-lg">{{ expressionData.description }}</p>
            </div>
          </div>
        ...
        <div v-else class="text-center py-12 bg-red-50 rounded-lg">
          ...
          <p class="text-gray-600 mt-1">Vui lòng nhập đầy đủ họ tên</p>
        </div>
      </transition>
    </div>
  </div>
