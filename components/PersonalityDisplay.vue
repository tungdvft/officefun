<template>
  <div class="container mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
    <div class="p-6 space-y-8">
      <h2 class="text-3xl font-bold text-center text-teal-700 mb-6">Chỉ Số Nhân Cách</h2>
      ...
      <transition name="fade-slide">
        ...
        <div v-else-if="showResult" class="space-y-6">
          <!-- Hiển thị số Nhân Cách (không bảo vệ) -->
...
const description = 'Access to detailed personality number interpretation';
