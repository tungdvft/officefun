    ...
    <div class="p-6 space-y-8">
      ...
      <transition name="fade-slide">
        ...
        <div v-if="number && data" class="space-y-8">
          <!-- Hiển thị chỉ số năng lực trưởng thành (không bảo vệ) -->
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-100 shadow-sm text-center">
            <div class="flex flex-col items-center">
              ...
              <h3 class="text-2xl font-bold text-teal-800 mt-6">Chỉ Số Năng Lực Trưởng Thành Của Bạn</h3>
              <p class="text-gray-600 mt-2 max-w-lg">Số năng lực trưởng thành: <span class="font-bold text-teal-600">{{ number }}</span></p>
            </div>
          </div>
        ...
        <div v-else class="text-center py-12 bg-red-50 rounded-lg">
          ...
          <p class="text-gray-600 mt-1">Không có dữ liệu chỉ số năng lực trưởng thành.</p>
        </div>
      </transition>
    </div>
  </div>
