  ...
  <div class="container mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
    <div class="p-6 space-y-8">
      ...
      <div class="text-center">
        <h2 class="text-3xl font-bold text-teal-700 mb-2">Chỉ Số Năng Lực Trưởng Thành</h2>
        <p class="text-lg text-gray-600">Khám phá năng lực trưởng thành tiềm ẩn của bạn</p>
      </div>

      <!-- Maturity power number card (không bảo vệ) -->
      <div v-if="number && data" class="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-100 shadow-sm text-center">
        <div class="flex flex-col items-center">
          ...
          <h3 class="text-2xl font-bold text-teal-800 mt-6">Chỉ Số Năng Lực Trưởng Thành {{ number }}</h3>
          <p class="text-gray-600 mt-2 max-w-lg">Chỉ số năng lực trưởng thành thể hiện sức mạnh nội tại và tiềm năng phát triển của bạn trong giai đoạn trưởng thành, thường sau 35 tuổi. Nó phản ánh khả năng bạn sử dụng kinh nghiệm và trí tuệ để định hình cuộc sống ý nghĩa. Đây là hành trình khám phá bản thân, nơi bạn phát huy thế mạnh để tạo ảnh hưởng tích cực. Chỉ số này định hướng bạn sống hài hòa với giá trị cốt lõi, mang lại sự cân bằng và thỏa mãn sâu sắc. Khám phá chi tiết để hiểu cách phát triển tối ưu tiềm năng của bạn.</p>
        </div>
      </div>
      ...
      <transition name="fade-slide">
        <div>
          ...
          >
            ...
            <p class="text-gray-600 mt-1">
              Không có dữ liệu chỉ số năng lực trưởng thành.
            </p>
          </div>
          ...
          <div v-else class="space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-start mb-4">
                  <div class="flex-shrink-0 p-2 bg-teal-100 rounded-lg text-teal-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 22" stroke="currentColor">
...
const description = 'Access to detailed mature power number interpretation';
const {
  isLoading,
  errorMessage,
  errorType,
...
const initializeAuth = async () => {
  console.log('Initializing auth for MaturePowerNumber...');
  try {
