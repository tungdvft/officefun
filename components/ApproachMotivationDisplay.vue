      ...
      <transition name="fade-slide">
        ...
        <div v-else-if="error" class="text-center py-12 bg-red-50 rounded-lg">
          ...
          <p class="text-gray-600 mt-1">
            Vui lòng nhập đầy đủ họ tên và ngày sinh hợp lệ (DD/MM/YYYY) để xem chỉ số động lực tiếp cận
          </p>
        </div>
...
const showResult = computed(() => {
  return motivationData.value !== null && motivationNumber.value !== null && !error.value;
});
