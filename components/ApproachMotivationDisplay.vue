        ...
        <div v-else-if="showResult" class="space-y-6">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-100 shadow-sm text-center">
            <div class="flex flex-col items-center">
              ...
              <h3 class="text-2xl font-bold text-teal-800 mt-6">Chỉ Số Động Lực Tiếp Cận {{ motivationNumber }}</h3>
...
const loadMotivationData = async () => {
  ...
  try {
    ...
    motivationData.value = {
      description: `Tạm thời chưa có dữ liệu chi tiết cho Chỉ số Động Lực Tiếp Cận ${motivationNumber.value || 'không xác định'}`,
