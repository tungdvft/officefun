...
<template>
  <div class="min-h-screen flex">
    <!-- Sidebar -->
    <div 
      :class="{ 'w-16 md:w-64': !isSidebarOpen, 'w-64': isSidebarOpen }" 
    ...
    <!-- Main Content -->
    <div class="flex-1 p-6 bg-gray-100 ml-16 md:ml-64">
      <slot />
    </div>
  </div>
</template>
...
// Trạng thái sidebar (chỉ toggle trên mobile)
